...
function Banner({ banner }) {
    return (
        <div className="moneyback shipping">
            ...
            <div className="col-md-6 moneyback-image-container">
                <Image src={process.env.NEXT_PUBLIC_API_HOST + banner.src} className="shipping-image" alt="bg" width={banner.width} height={banner.height}></Image>
